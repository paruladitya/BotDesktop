...
class RecorderService {
    ...
    async startRecording() {
        ...
        try {
            ...
            //@ts-ignore
            const screen = await electron_1.ipcRenderer.invoke('get-screenshot');
            console.log(screen);
    ...
    async startMicrophoneCapture() {
        ...
        try {
            ...
            await electron_1.ipcRenderer.on('audio-level', this.handleAudioLevel);
            await electron_1.ipcRenderer.on('audio-chunk', this.handleAudioChunk);
